...
Now we can rarefy
```{r}
ps_rarefy <- rarefy_even_depth(pss, rngseed = 15)
...
Exercise: Re-run the commands you created above to create the bulk and rhizosphere phyloseq objects using the transformed data. 
```{r}
ps<-ps_transformed
```
