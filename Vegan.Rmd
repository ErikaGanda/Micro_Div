...
Since we have already gone over the basics of ordination in Phyloseq we will not rehash those details here. Instead we will look at an alternative way to achieve the same result. In this tutorial we will also take advantage of base R's graphics. You will see how different a ggplot graphic is from the base R version of the same plot. 
